...
<body class="animsition">
	...
	<div class="container p-t-80 p-b-50">
		<div class="text-center p-t-50 p-b-50"
			style="background: #fff; border: 1px solid #eee; border-radius: 12px; max-width: 600px; margin: 0 auto; box-shadow: 0 10px 40px rgba(0,0,0,0.05);">
			<div
				style="width: 80px; height: 80px; border-radius: 50%; background: #ffeaea; color: #EF9C78; display: flex; align-items: center; justify-content: center; font-size: 40px; margin: 0 auto 20px;">
				<i class="zmdi zmdi-close"></i>
			</div>
			<h1
				style="font-family: 'Poppins', sans-serif; font-size: 28px; font-weight: 800; color: #111; margin-bottom: 12px;">
				Order Cancelled Successfully</h1>
			<p
				style="font-family: 'Inter', sans-serif; font-size: 15px; color: #666; font-weight: 500; margin-bottom: 30px; padding: 0 40px;">
				Your order has been cancelled. If you have already paid, the payment will be refunded to your original
				payment method within 7 working days.</p>

			<div class="flex-w flex-c-m" style="gap: 15px;">
				<a href="index.php" class="stext-101 cl0 trans-04 pointer"
					style="background: #EF9C78; color: white; border-radius: 8px; font-weight: 700; font-family: 'Poppins', sans-serif; font-size: 15px; padding: 12px 25px; transition: all 0.3s; box-shadow: 0 5px 15px rgba(227,29,26,0.3);"
					onmouseover="this.style.background='#111'; this.style.boxShadow='0 5px 15px rgba(0,0,0,0.2)';"
					onmouseout="this.style.background='#EF9C78'; this.style.boxShadow='0 5px 15px rgba(227,29,26,0.3)';">
					Back to Home
				</a>
				<a href="order-list.php" class="stext-101 cl0 trans-04 pointer"
					style="background: #fff; color: #111; border: 2px solid #ddd; border-radius: 8px; font-weight: 700; font-family: 'Poppins', sans-serif; font-size: 15px; padding: 10px 25px; transition: all 0.3s;"
