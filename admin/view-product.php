                ...
                <table id="example2" class="table table-bordered table-hover display_product_admin_page_change">
                  ...
                  <?php while ($row = mysqli_fetch_assoc($data)) { ?>
                   ...
                   <tr>
                    ...
                    <td><a href="view-more-product.php?v_id=<?php echo $row['id']; ?>" class="btn btn-info btn-sm">View More</a></td>
                    <td>
                      <a href="edit-product.php?e_id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit</a>
                    </td>
                    <td>
                      <a href="delete-product.php?d_id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this product?')">Delete</a>
                    </td>
                  </tr>
