...
if (isset($_GET['d_id']))
{
    ...
    if(file_exists('image/'.$delete_img)) {
                  ...
                  <?php while ($row = mysqli_fetch_assoc($data)) { ?>
                   ...
                   <tr>
                    ...
                    <td><?php echo $row['tag']; ?></td>
                     <td align="center">
                          <div style="width: 200px; height: 150px;"><img src="image/<?php echo $row['image']; ?>" style="height: 100%; width: 100%; object-fit: cover;"></div>
                     </td>
                     <td><a href="edit-blog.php?e_id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit</a></td>
                     <td><a href="view-blog.php?d_id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure?')">Delete</a></td>
                  </tr>
