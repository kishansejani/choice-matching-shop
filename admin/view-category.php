...
if (isset($_GET['d_id'])) {
    ...
    header('location:view-category.php?success=1');
    exit;
}
            ...
            <div class="card">
                <div class="card-body">
                    <table id="example2" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            <?php
                            $res = mysqli_query($conn, "SELECT * FROM `category` ORDER BY sequence ASC, id DESC");
                            while ($row = mysqli_fetch_assoc($res)) {
                                ...
                                echo "<tr>
                                    ...
                                    <td>
                                        <a href='edit-category.php?e_id={$row['id']}' class='btn btn-primary'>Edit</a>
                                    </td>
                                    <td>
