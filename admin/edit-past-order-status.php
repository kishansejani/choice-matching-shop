...
$view_id = isset($_GET['e_id']) ? mysqli_real_escape_string($conn, $_GET['e_id']) : 0;
...
if (!$row) {
    header('location:view-all-orders.php');
    exit;
}
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered">
                  ...
                  <tr>
                    <th>Image-1 (Main)</th>
                    <td align="center">
                          <div style="width: 250px; height: 200px;"><img src="image/<?php echo $row['image']; ?>" style="height: 100%; width: 100%; object-fit: cover; object-position: top;"></div>
                    </td>
                  </tr>
