        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
              <h3 class="card-title m-0">Manage About Us</h3>
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php while ($row = mysqli_fetch_assoc($data_story)) { ?>
                  ...
                  <tr>
                    ...
                    <td align="center">
                      <div style="width: 200px; height: 150px;"><img src="image/<?php echo $row['story_image']; ?>"
                          style="height: 100%; width: 100%; object-fit: cover;">
                    </td>
              </div>
              </td>
              <td valign="center"><a href="edit-story.php?e_id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit</a>
              </td>
              </tr>
            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <?php while ($row = mysqli_fetch_assoc($data_mission)) { ?>
                ...
                <tr>
                  ...
                  <td align="center">
                    <div style="width: 200px; height: 150px;"><img src="image/<?php echo $row['mission_image']; ?>"
                        style="height: 100%; width: 100%; object-fit: cover;">
                  </td>
            </div>
            </td>
            <td valign="center"><a href="edit-mission.php?e_id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit</a>
            </td>
            </tr>
          ...
          <table id="example2" class="table table-bordered table-hover">
            ...
            <?php while ($row = mysqli_fetch_assoc($data_thought)) { ?>
              ...
              <tr>
                ...
                <td valign="center"><a href="edit-thought.php?e_id=<?php echo $row['id']; ?>"
